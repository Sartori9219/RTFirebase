...
function Percentage({ questions, currentQuestion }) {
  ...
  for (let i = 0; i < questions[currentQuestion].questions.length; i++) {
    if (questions[currentQuestion].questions[i].isPassed === true) {
      countStepPassed++;
    }
  }

  stepPercentage =
    (countStepPassed / questions[currentQuestion].questions.length) * 100;
  return (
